...
import 'pages/lifetime_record_block_display_page.dart';
...
class LifetimeRecordBlockDisplayAlert extends ConsumerWidget {
  LifetimeRecordBlockDisplayAlert({super.key, required this.date});
    ...
    list
      ...
      ..forEach((element) {
        tabs.add(
          TabInfo(
            element.toString(),
            LifetimeRecordBlockDisplayPage(date: DateTime(element)),
          ),
        );
      });
  }
