...
part of 'balance_sheet_response_state.dart';
...
/// @nodoc
mixin _$BalanceSheetResponseState {
  AsyncValue<List<Balancesheet>> get balanceSheetList =>
      throw _privateConstructorUsedError;

  @JsonKey(ignore: true)
  $BalanceSheetResponseStateCopyWith<BalanceSheetResponseState> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $BalanceSheetResponseStateCopyWith<$Res> {
  factory $BalanceSheetResponseStateCopyWith(BalanceSheetResponseState value,
          $Res Function(BalanceSheetResponseState) then) =
      _$BalanceSheetResponseStateCopyWithImpl<$Res, BalanceSheetResponseState>;
  @useResult
  $Res call({AsyncValue<List<Balancesheet>> balanceSheetList});
}

/// @nodoc
class _$BalanceSheetResponseStateCopyWithImpl<$Res,
        $Val extends BalanceSheetResponseState>
    implements $BalanceSheetResponseStateCopyWith<$Res> {
  _$BalanceSheetResponseStateCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      balanceSheetList: null == balanceSheetList
          ...
          : balanceSheetList // ignore: cast_nullable_to_non_nullable
              as AsyncValue<List<Balancesheet>>,
    ) as $Val);
  }
}
...
class _$BalanceSheetResponseStateImpl implements _BalanceSheetResponseState {
  ...
  @override
  String toString() {
    return 'BalanceSheetResponseState(balanceSheetList: $balanceSheetList)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, balanceSheetList);
